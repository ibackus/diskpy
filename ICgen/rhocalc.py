...
def rho_z(sigma, T, r, settings, rhoguess = None):
    """ 
    rho,z = rho_z(...)
...
#        rhoguess.convert_units(mass_unit/length_unit**3)
#        rhoguess = isaac.strip_units(rhoguess)
#        guess = (rhoguess.sum() - np.cumsum(rhoguess)) * dz
        ...
        rhoguess.convert_units(mass_unit/length_unit**3)
        rho0 = isaac.strip_units(rhoguess)
    ...
    return SimArray(rho0,'Msol au**-3'), SimArray(z,'au'), n
